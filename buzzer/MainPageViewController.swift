...
class MainPageViewController: UIPageViewController, UIPageViewControllerDataSource {
    ...
    lazy var allViewControllers: [UIViewController] = {
            return [self.viewControllerFromStoryboard(withName: "clipperViewController"), self.viewControllerFromStoryboard(withName: "bugViewController"), self.viewControllerFromStoryboard(withName: "scaryViewController"), self.viewControllerFromStoryboard(withName: "toiletViewController"), self.viewControllerFromStoryboard(withName: "reviewViewController")]
        }()
